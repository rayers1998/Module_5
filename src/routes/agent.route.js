...
const agentRouteEndpoint = (app) => {
    ...
    app.post('/agent-create', 
        ...
        AGENT_CONTROLLER.createAgent
    );

    // Get all agents (requires token authentication)
    app.get('/agents', 
        BASE_MIDDLEWARE.authenticateToken, 
        AGENT_CONTROLLER.getAllAgents
    );
    ...
    app.get('/agents-by-region', 
        BASE_MIDDLEWARE.authenticateToken, 
        BASE_MIDDLEWARE.jwtAuthToken, 
        AGENT_CONTROLLER.getAgentsByRegion
    );
    ...
    app.patch('/agent-update-info/:id', 
        BASE_MIDDLEWARE.authenticateToken, 
        BASE_MIDDLEWARE.jwtAuthToken, 
        AGENT_CONTROLLER.updateAgentInfo
    );
